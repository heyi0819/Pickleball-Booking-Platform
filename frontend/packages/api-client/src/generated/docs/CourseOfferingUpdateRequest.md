...
```typescript
import type { CourseOfferingUpdateRequest } from '@pickleball/api-client-generated'
...
const example = {
  ...
  "sessionPlans": null,
} satisfies CourseOfferingUpdateRequest
...
const exampleParsed = JSON.parse(exampleJSON) as CourseOfferingUpdateRequest
