...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(BusinessException.class) @ResponseStatus(HttpStatus.CONFLICT) ErrorResponse business(BusinessException e, HttpServletRequest r) { return error(e.code(), e.getMessage(), r); }
